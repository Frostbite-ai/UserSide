...
function Calendar() {
  ...
  const events = [
    ...
    },
    {
      ...
      eventName: "Banking and Savings Camp",
      eventColor: "sky",
    },
    {
      eventStart: new Date(
      ...
      eventEnd: "",
      eventName: "Employment and Skill Development Schemes",
      eventColor: "yellow",
    },
    // Current month
    {
      ...
      eventName: "Small Business Development",
      eventColor: "sky",
    },
    {
      eventStart: new Date(
      ...
      eventEnd: "",
      eventName: "Nutrition and Healthy Living",
      eventColor: "indigo",
    },
    {
      eventStart: new Date(
      ...
      eventName: "Social Assistance Programs and Subsidies",
      eventColor: "yellow",
    },
    {
      eventStart: new Date(
      ...
      eventName: "Domestic Violence Camp",
      eventColor: "red",
    },
    {
      eventStart: new Date(
    ...
    },
    {
      ...
      eventEnd: "",
      eventName: "Child Rights and Protection",
      eventColor: "emerald",
    },
    {
      eventStart: new Date(
      ...
      eventName: "Women's Rights and Empowerment",
      eventColor: "emerald",
    },
    {
      eventStart: new Date(
    ...
    },
    {
      ...
      eventName: "Skill Development Schemes",
      eventColor: "yellow",
    },
    {
      eventStart: new Date(
    ...
    },
    {
      ...
      eventEnd: "",
      eventName: "Senior Citizens' Rights and Welfare",
      eventColor: "red",
    },
    {
      eventStart: new Date(
                ...
                <ul className="flex flex-wrap items-center -m-1">
                  <li className="m-1">
                    <button className="btn-sm bg-white border-slate-200 hover:border-slate-300 text-slate-500">
                      ...
                      <span className="ml-1.5">Financial Empowerment</span>
                    </button>
                  </li>
                  <li className="m-1">
                    <button className="btn-sm bg-white border-slate-200 hover:border-slate-300 text-slate-500">
                  ...
                  <li className="m-1">
                    <button className="btn-sm bg-white border-slate-200 hover:border-slate-300 text-slate-500">
                      ...
                      <span className="ml-1.5">Health and Wellbeing</span>
                    </button>
                  </li>
                  <li className="m-1">
                    <button className="btn-sm bg-white border-slate-200 hover:border-slate-300 text-slate-500">
